  ...
  return (
    <div className="space-y-8 pb-6">
      <header className="space-y-2">
        <p className="text-xs uppercase tracking-[0.3em] text-slate-400">Bag</p>
        <h1 className="text-2xl font-semibold text-slate-900">Your gear ({bagCount})</h1>
        <p className="text-sm text-slate-500">Free express shipping and 30-day testing on every order.</p>
      </header>

      <section className="space-y-4">
        {bagItems.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-slate-200 bg-white/80 p-8 text-center text-sm text-slate-500">
            Your bag is empty. Browse the shop to add race-ready gear.
      ...
      <section className="space-y-4 rounded-3xl border border-slate-200 bg-white/90 p-5 shadow-sm">
        <h2 className="text-sm font-semibold uppercase tracking-[0.3em] text-slate-400">Summary</h2>
        ...
        <div className="space-y-3">
          {giftCard ? (
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              <p className="mt-2 text-xs text-slate-400">Tip: Use ONRUN25 for CHF 25 off.</p>
            </div>
          )}
      ...
      {recommendations.length > 0 ? (
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-slate-400">Recommended</p>
              <h2 className="text-lg font-semibold text-slate-900">Pairs well with</h2>
            </div>
